...
import { screen, render } from "../lib/vitest/test-util.ts";
import { TamiyaColor } from "./TamiyaColor.tsx";
...
describe("TamiyaColorのテスト", () => {
  describe('単一データのテスト', () => {
    ...
    it("画像が表示されること", () => {
      ...
      expect(imageElement).toHaveAttribute(
        "src",
        "https://www.tamiya.com/english/products/81502/img/81502_01.jpg"
      );
    });
  });
  ...
  describe('複数データのテスト', () => {
    it("複数の画像が表示されること", () => {
      ...
      expect(blueImageElement).toHaveAttribute(
        "src",
        "https://www.tamiya.com/english/products/81503/img/81503_01.jpg"
      );
